...
private:
        ...
        std::shared_ptr<const MoveJs::Goal> goal)
    {
        ...
        JointGoal =  goal->goal;
        RCLCPP_INFO(get_logger(), "Received a goal request, with JointPose -> (%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f)",
        JointGoal.joint_1,JointGoal.joint_2,JointGoal.joint_3,JointGoal.joint_4,JointGoal.joint_5,JointGoal.joint_6,JointGoal.joint_7,JointGoal.joint_8);
        (void)uuid;
    ...
    void execute(const std::shared_ptr<GoalHandle> goal_handle)
    {
        ...
        double j1 = JointGoal.joint_1;
        double j2 = JointGoal.joint_2;
        double j3 = JointGoal.joint_3;
        double j4 = JointGoal.joint_4;
        double j5 = JointGoal.joint_5;
        double j6 = JointGoal.joint_6;
        double j7 = JointGoal.joint_7;
        double j8 = JointGoal.joint_8;
