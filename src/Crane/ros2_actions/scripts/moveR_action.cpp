...
private:
    ...
    void execute(const std::shared_ptr<GoalHandle> goal_handle)
    {
        ...
        RCLCPP_INFO(this->get_logger(), "Current JOINT VALUES before MoveRs are -> (j1 = %.2f, j2 = %.2f, j3 = %.2f, j4 = %.2f, j5 = %.2f, j6 = %.2f)", j1, j2, j3, j4, j5, j6);
        ...
        if (LimitCheck == false){
            ...
            if(success) {
                ...
                RCLCPP_INFO(this->get_logger(), "%s - MoveRss: Planning successful!", my_param.c_str());
