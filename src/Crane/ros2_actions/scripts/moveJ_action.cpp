...
private:
        ...
        std::shared_ptr<const MoveJ::Goal> goal)
    {
        ...
        JointGoal =  goal->goal;
        RCLCPP_INFO(get_logger(), "Received a goal request, with JointPose -> (%.2f,%.2f,%.2f,%.2f,%.2f,%.2f)", 
        JointGoal.joint_1, JointGoal.joint_2, JointGoal.joint_3, JointGoal.joint_4, JointGoal.joint_5, JointGoal.joint_6);
        //(void)uuid;
