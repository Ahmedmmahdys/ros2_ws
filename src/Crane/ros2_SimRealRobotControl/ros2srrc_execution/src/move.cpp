...
int main(int argc, char ** argv)
{
    ...
    if (param_ROB != "none"){
        ...
        std::cout << param_ROB <<std::endl;
        
        
        move_group_interface_ROB = MoveGroupInterface(node2, name); // Moveit: ready to take commands client waits server 
        
        
        std::cout << "sasasasasasasasasasa\n" <<std::endl;
