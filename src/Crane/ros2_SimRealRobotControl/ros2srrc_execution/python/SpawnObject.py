...
def main():
    ...
    urdf_file_path = os.path.join(get_package_share_directory(args.package), 'urdf', 'Ithems', args.urdf) # It is assumed that the .urdf/.xacro file is located in /urdf/objects folder!
    xacro_file = xacro.process_file(urdf_file_path, mappings={"name": args.name, "namespace": args.namespace})
