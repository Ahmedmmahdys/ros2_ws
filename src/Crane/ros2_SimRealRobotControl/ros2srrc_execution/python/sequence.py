...
def main(args=None):
    ...
    # Change here # 
    #filepath = os.path.join(os.path.expanduser('~'), 'appdata', 'ros_2','ws_SimToReal','src', 'ros2_SimRealRobotControl', 'ros2srrc_execution', 'programs', PR_NAME + ".txt")
    filepath = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'programs', PR_NAME + ".txt")
