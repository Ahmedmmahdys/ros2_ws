...
class RobotPARAM(Node):
    def __init__(self):
        ...
        if (PARAM_ROBOT == "default"):
            ...
            # Check value:
            if (PARAM_ROBOT == "towercrane" or
                PARAM_ROBOT == "irb120" or 
...
def main(args=None):
    ...
    elif (PARAM_ROBOT == "towercrane" or
          PARAM_ROBOT == "panda" or
          PARAM_ROBOT == "iiwa"):
    ...
    filepath = os.path.join(os.path.expanduser('~'), 'appdata', 'ros_2', 'ws_towercrane', 'src', 'ros2_execution', 'programs', PR_NAME + ".txt")
    ...
    for i in range (1, len(seq)+1):
        ...
        if (trigger['action'] == 'MoveJ'):
            ...
            JP = JointPose()
            JP.joint_1 = trigger['value']['joint_1']
            JP.joint_2 = trigger['value']['joint_2']
            JP.joint_3 = trigger['value']['joint_3']
            JP.joint_4 = trigger['value']['joint_4']
            JP.joint_5 = trigger['value']['joint_5']
            JP.joint_6 = trigger['value']['joint_6']
            ...
            JPS = JointPoseS()
            JPS.joint_1 = trigger['value']['joint_1']
            JPS.joint_2 = trigger['value']['joint_2']
            JPS.joint_3 = trigger['value']['joint_3']
            JPS.joint_4 = trigger['value']['joint_4']
            JPS.joint_5 = trigger['value']['joint_5']
            JPS.joint_6 = trigger['value']['joint_6']
            JPS.joint_7 = trigger['value']['joint_7']
